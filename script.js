...
const COMMENTS_API_URL = 'https://script.google.com/macros/s/AKfycbxmyD3_ShMkHYcNMcU3s_oU2tNMEN2GXLko4H5FMSfsSbf2RzvoEVeVyrmAgYGy2UdC/exec';
...
async function saveComment(bookId, name, text) {
    try {
        const res = await fetch(COMMENTS_API_URL, {
            ...
            body: JSON.stringify({ bookId: String(bookId), name, text })
        });
        return res.ok;
